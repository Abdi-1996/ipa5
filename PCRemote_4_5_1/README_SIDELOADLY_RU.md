...
2. Откройте **Actions → Build PC Remote 4.3**.
3. Нажмите **Run workflow**.
4. После успешной сборки скачайте artifact **PCRemote-4.3-IPA**.
...
1. В той же сборке GitHub Actions скачайте artifact **PCRemote-4.3-Windows**.
